...
export const TERRAIN = {
  ...
  cusgs: { label: "Contours, USGS (interval by scale)", kind: "raster", source: { type: "raster", tiles: ["https://carto.nationalmap.gov/arcgis/rest/services/contours/MapServer/export?bbox={bbox-epsg-3857}&bboxSR=3857&imageSR=3857&size=512,512&format=png32&transparent=true&f=image"], tileSize: 512, minzoom: 5, maxzoom: 15, attribution: "USGS The National Map, 3DEP contours" }, opacity: 0.85, note: "USGS 3DEP contours drawn at any zoom: small-scale index contours when zoomed out, 100 ft, then 50 ft, then the full set below 1:50,000. Use for a whole-area view; switch to the MnGeo lidar contours at zoom 12+ for site work." },
