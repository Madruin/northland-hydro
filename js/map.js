...
const visibility = { crithab: false, huc: false, landcover: false, stations: true, gauges: true, qpe: false, streams: false, soils: false, parcels: false, trout: false, karst: false, wetlands: false, fema: false, crossings: false, wells: false, pwi: false, impaired: false, easements: false };
let parcelsData = { type: "FeatureCollection", features: [] };
let lakeFeature = null;
const OVERLAYS = { huc8: "huc", huc10: "huc", huc12: "huc", "huc8-lbl": "huc-label", "huc10-lbl": "huc-label", "huc12-lbl": "huc-label", "fema-zones": "fema-fill", "fema-lomr": "fema-lomr", wetlands: "fill", trout: "line", "karst-poly": "fill", "karst-pts": "point", springs: "point", "fema-bfe": "fema-line", "fema-xs": "fema-xs", "xing-dnr": "point", "xing-nbi": "diamond", wells: "point", drillholes: "diamond", wlssd: "point", "pwi-basins": "fill", "pwi-lines": "line", "tmdl-areas": "fill", "imp-lakes": "fill", "imp-streams": "line", rim: "fill", wetbank: "fill", obwells: "point", crithab: "fill" };
const overlayData = {};
...
function setupHover() {
  ...
  map.on("mousemove", (e) => {
    ...
    if (!feats.length) { const ov = ["ov-wlssd", "ov-wells", "ov-drillholes", "ov-obwells", "ov-imp-streams", "ov-pwi-lines", "ov-rim", "ov-wetbank", "ov-imp-lakes", "ov-pwi-basins", "ov-tmdl-areas", "ov-xing-dnr", "ov-xing-nbi", "ov-karst-pts", "ov-springs", "ov-fema-xs", "ov-fema-bfe", "ov-trout", "ov-fema-lomr", "ov-karst-poly", "ov-wetlands", "ov-fema-zones", "ov-crithab", "ov-huc12", "ov-huc10", "ov-huc8"].filter((l) => map.getLayer(l) && map.getLayoutProperty(l, "visibility") === "visible"); if (ov.length) { feats = map.queryRenderedFeatures(e.point, { layers: ov }); anchor = e.lngLat; } }
