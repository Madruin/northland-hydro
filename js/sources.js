...
export const SOURCES = [
  ...
  { group: "Rivers, lakes and gauges", items: [
    ...
    { name: "MN DNR Public Waters Inventory", url: "https://www.dnr.state.mn.us/waters/watermgmt_section/pwi/index.html", use: "Public waters layer and point section: public water basins and wetlands with DNR shoreland class, and public watercourses; a public waters work permit is needed for bed or bank work below the OHWL.", note: "GIS delineations; the official PWI maps and the area hydrologist govern." },
    { name: "MPCA impaired waters (2024 303(d) list) and TMDL allocation areas", url: "https://www.pca.state.mn.us/air-water-land-climate/minnesotas-impaired-waters-list", use: "Impaired layer, point section (nearest reaches and lakes with impairments, affected uses, TMDL approved or needed, allocation areas containing the point) and the watershed section's list of impaired waters in the basin." },
    { name: "BWSR RIM conservation easements and wetland banking easements", url: "https://bwsr.state.mn.us/easements", use: "Easements layer and point section with easement number, type, acres, year, status and SWCD." },
    { name: "MN DNR Cooperative Groundwater Monitoring (observation wells)", url: "https://www.dnr.state.mn.us/waters/cgm/index.html", use: "Observation wells on the Wells layer and in the point section, with aquifer, depth, read status and a link to each well's water-level record." },
  ...
  { group: "Terrain and imagery", items: [
    ...
    { name: "MnTOPO 2nd-generation lidar (USGS 3DEP, 2021–2024)", url: "https://www.mngeo.state.mn.us/chouse/elevation/lidar.html", use: "0.5 m hillshade rendered live; point elevation and line profiles from the seamless DEM image service (identify and getSamples); DEM clips and contours for the CAD export from the cloud-optimized GeoTIFFs (NAVD88). The 1 m 2008–12 DEM is the fallback where the new lidar is missing." },
