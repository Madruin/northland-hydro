...
export const SOURCES = [
  ...
  { group: "Terrain and imagery", items: [
    ...
    { name: "MnGeo composite aerial imagery (WMS)", url: "https://www.mngeo.state.mn.us/chouse/wms/geo_image_server.html", use: "High-resolution Imagery basemap: the statewide composite of the newest, sharpest county and FSA photography, re-projected tile by tile from UTM 15N in the browser.", note: "Zoom 16 and beyond shows the county orthophotos where they exist (often 0.15 to 0.3 m)." },
