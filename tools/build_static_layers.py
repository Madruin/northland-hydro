...
LAYERS = {
    ...
    "rim":         (f"{B}/us_mn_state_bwsr/bdry_bwsr_rim_cons_easements/FeatureServer/0", "ease_num,ease_type,ease_cat,ease_acres,ease_year,exp_status,swcd_name", None),
    "wetbank":     (f"{B}/us_mn_state_bwsr/bdry_wetland_banking_easements/FeatureServer/0", "county,siteid,easement_number,acres,instrument_type,recording_date", None),
    "imp-streams": (f"{B}/us_mn_state_pca/env_impaired_water_2024/FeatureServer/7", "auid,name,reach_desc,affected_u,imp_param,approved,needs_pln", None),
    "imp-lakes":   (f"{B}/us_mn_state_pca/env_impaired_water_2024/FeatureServer/13", "auid,name,reach_desc,affected_u,imp_param,approved,needs_pln,area_acres", "area_acres < 200000"),
    "tmdl-areas":  (f"{B}/us_mn_state_pca/env_tmdl_allocation_areas/FeatureServer/3", "waterbody_name,tmdl_pollutant,epa_approval,source,area_sq_mi", None),
    "pwi-basins":  (f"{B}/us_mn_state_dnr/water_mn_public_waters/FeatureServer/1", "pw_basin_name,dowlknum,pwi_class,pwi_label,wettype,acres,dnr_shoreland_class", "dowlknum <> '16000100'"),
